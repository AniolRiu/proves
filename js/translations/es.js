...
var i18n = {
	...
	"opció":"opción",
	"No s'han trobat usuaris amb aquest nick i contrassenya." : "No se han encontrado usuarios con este nick y contraseña",
	"Aquest usuari existeix però encara no ha validat el seu email." : "El usuario existe pero aún no ha validado su dirección de correo",
	"La connexió ha fallat.":"La conexión ha fallado",
	"No hi ha més preguntes disponibles.":"No hay más preguntas disponibles",
	"Paràmetres incorrectes":"Parámetros incorrectos",
	"No s'han trobat preguntes.":"No se han encontrado preguntas",
	"Aquesta pregunta ja havia estat marcada com a inapropiada per aquest usuari.":"Esta pregunta ya había sido marcada como inapropiada por éste usuario.",
	"La pregunta s'ha marcat com a inapropiada.":"La pregunta se ha marcado como inapropiada.",
	"No s'ha pogut afegir la pregunta.":"No se ha podido añadir la pregunta.",
	"No s'ha trobat la pregunta.":"No se ha encontrado la pregunta.",
};